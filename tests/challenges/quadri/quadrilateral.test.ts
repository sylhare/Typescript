...
describe('Quadrilateral', () => {
  describe('pointInQuad', () => {
    it.each<[string, Point, Quad, boolean]>([
      ['point clearly inside',              { x: 3, y: 2 },   quad, true],
      ['point on bottom edge',              { x: 3, y: 0.5 }, quad, true],
      ...
      ['point on flat quad boundary',       { x: 3, y: 0 },   flatQuad, true],
      ['point above flat quad',             { x: 3, y: 1 },   flatQuad, false],
  ...
  describe('lineIntersectsQuadLine (infinite line)', () => {
    it.each<[string, Point, Point, Quad, boolean]>([
      ['line crosses quad horizontally',            { x: -1, y: 2 },  { x: 7, y: 2 }, quad, true],
      ['line crosses quad diagonally',              { x: -1, y: -1 }, { x: 7, y: 7 }, quad, true],
      ['line collinear with bottom edge',           { x: 0, y: 0 },   { x: 6, y: 1 }, quad, true],
      ['line passes through a vertex',              { x: -1, y: -1 }, { x: 0, y: 0 }, quad, true],
